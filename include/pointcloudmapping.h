...
public:
    ...
    void insertKeyFrame2( KeyFrame* kf, cv::Mat& color, cv::Mat& depth,int idk,vector<KeyFrame*> vpKFs);
    void shutdown();
    void viewer();
    ...
    bool bStop = false;
    int numKeyFrame=0;
    void saveKeyFramePointCloud(const string &filename,PointCloud::Ptr p);
    void mergeAllKeyFrame();
...
protected:
    ...
    vector<PointCloude>     pointcloud2;
    vector<PointCloude2>     pointcloud3;
