        ...
        mbDeactivateLocalizationMode(false)
{
	...
	//初始化追踪线程，该线程在主线程中运行,mpPointCloudMapping
	//mpPointCloudMapping在track阶段插入关键帧insertKeyFrame
	...
	//初始化并启动回环线程
	//回环检测阶段，将关键帧数据保存到点云中mpPointCloudMapping
	//每次回环都更新一次点云
...
void System::Shutdown()
{
    ...
    //mpPointCloudMapping->mergeAllKeyFrame();
